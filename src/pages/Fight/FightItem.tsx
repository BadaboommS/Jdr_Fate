...
export function FightItem ({ fightData, handleDeleteFight }: FilterItemPropsInterface) {
    return (
        <div className="flex items-center gap-2 border border-black p-2 bg-[#DFDDCF] text-black rounded cursor-pointer">
            <button className="cursor-pointer" onClick={() => console.log(fightData)}>{fightData.fightName}</button>
